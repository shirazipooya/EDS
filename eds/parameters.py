...
class Parameters():
    ...
    def genetic_mechanistic(
        ...
        genetic_mechanistic_para = {
            ...
            "Susceptible": {
                "p_opt": self.p_opt["Susceptible"],
                "rc_opt_par": self.rc_opt_par["Susceptible"],
                "rrlex_par": self.rrlex_par["Susceptible"]
            },

            "Moderate": {
                "p_opt": self.p_opt["Moderate"],
                "rc_opt_par": self.rc_opt_par["Moderate"],
                "rrlex_par": self.rrlex_par["Moderate"]
            },

            "Resistant": {
                "p_opt": self.p_opt["Resistant"],
                "rc_opt_par": self.rc_opt_par["Resistant"],
                "rrlex_par": self.rrlex_par["Resistant"]
            }
